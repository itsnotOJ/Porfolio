...
const allProjects: ProjectCardData[] = [
  ...
  },
  {
    ...
    description:
      "An easy-to-use platform that connects clients to verified artisans and service providers for on-demand or scheduled jobs, while supporting providers and admins with efficient tools.",
    overview:
      "Finding reliable, vetted artisans for everyday and urgent jobs is often a frustrating experience for clients. At the same time, skilled providers and small trade businesses struggle to reach enough customers or manage their bookings, payments, and daily operations efficiently. Oxtago bridges this gap by providing a unified, trusted platform that handles everything from discovery and booking to payments and job management. I designed Oxtago as a responsive web application that serves three distinct user types—Clients, Providers, and Admins—each with tailored interfaces and workflows. The result is a seamless ecosystem that streamlines workflows, builds trust through verified profiles and secure payments, and empowers users with intelligent automation.",
    keyFeatures: [
